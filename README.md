...
## Capacidade:
Análise de Logs: Sistema, SSH e Serviços;
Análise de portas UDP e TCP;
Monitoramento de processos e serviços rodando no sistema;
Extração de strings (Capturando: Email, URL e IP);
